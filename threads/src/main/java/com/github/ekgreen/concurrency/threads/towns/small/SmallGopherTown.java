package com.github.ekgreen.concurrency.threads.towns.small;

import com.github.ekgreen.concurrency.threads.toolbox.GopherThread;
    ...
    public synchronized void start() throws Exception {
        ...
        while (true) {
            try {
                ...
                final Thread equipExpedition = new GopherThread(new EquipExpedition(connection));
                equipExpedition.start();
